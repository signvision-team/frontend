    ...
    <div className="admin-panel-wrapper">
      ...
      <div className="mb-8">
        ...
        <p className="admin-subtitle">
          Resolve technical and curriculum hurdles for students and faculty
        </p>
      </div>
                ...
                >
                  ...
                  <div className="issue-meta">
                    <span className="meta-user">
                      <User size={14} /> {issue.studentName}
                    </span>
                    <span className="meta-tag">{issue.category}</span>
                    <span className="meta-date">{issue.createdAt}</span>

                    {issue.messages > 0 && (
                      <span className="meta-msg">
                        <MessageSquare size={14} /> {issue.messages}
                      </span>
                    )}
                  </div>
                </div>
          ...
          {selectedIssue ? (
            ...
            <div className="empty-state admin-card">
              ...
              <p className="text-gray-400">
                Select a support ticket to view full logs and resolution tools
              </p>
            </div>
          )}
