...
const SignUp = ({ navigate, VIEWS }) => {
  ...
  return (
    // Uses the full-screen wrapper defined in your App.css
    <div className="sign-in-page-wrapper"> 
      
      {/* CORNER LOGO (Top Left) */}
      <div className="corner-logo-container">
          <img src="/svLogo.png" alt="SignVision" style={{ height: '50px' }} />
      </div>
      ...
      <div className="hero-section" style={{ paddingTop: '50px', paddingBottom: '30px' }}>
        ...
        {/* Card: Using the optimized size (form-reg-card) */}
        <div className="card-common form-reg-card">
          ...
          <div style={{ marginTop: '10px', fontSize: '0.9rem', color: '#e0e0e0' }}>
            ...
            <p style={{ marginTop: '5px', cursor: 'pointer' }} className="link-text" onClick={() => navigate(VIEWS.SIGN_UP_TYPE)}>
                ← Back to Selection
            </p>
          </div>
